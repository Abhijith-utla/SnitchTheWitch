    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          ...
          className?.includes('purple') && 'bg-purple-500/20'
        )}
      >
        <SliderPrimitive.Range
          ...
          className={cn(
            ...
            className?.includes('purple') && 'bg-purple-500'
          )}
        />
      </SliderPrimitive.Track>
      {Array.from({ length: _values.length }, (_, index) => (
        <SliderPrimitive.Thumb
          ...
          className={cn(
            ...
            className?.includes('purple') ? 'border-purple-500 ring-purple-500/50' : 'border-primary'
          )}
        />
      ))}
    </SliderPrimitive.Root>
